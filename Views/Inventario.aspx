        ...
        <table>
            <tr>
                ...
                <td>
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:proyecto_ayd1ConnectionString %>" SelectCommand="SELECT [id], [nombre] FROM [producto]"></asp:SqlDataSource>
                </td>
            </tr>
        </table>
    </p></center>
